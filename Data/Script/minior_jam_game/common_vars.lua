...
function COMMON.UpdateDayEndVars()
  ...
  if _DATA.Save:GetDungeonUnlock("windswept_trail") ~= RogueEssence.Data.GameProgress.UnlockState.None then
     if SV.missions.Missions["RedMiniorRescue"] == nil and SV.missions.FinishedMissions["RedMiniorRescue"] == nil then
