...
--New
SV.mart_shop = {
  { Index = "berry_oran", Amount = 0, Price = 25},
  { Index = "berry_oran", Amount = 0, Price = 25},
  { Index = "berry_oran", Amount = 0, Price = 25},
  { Index = "berry_leppa", Amount = 0, Price = 80},
  { Index = "berry_pecha", Amount = 0, Price = 20},
	{ Index = "food_apple", Amount = 0, Price = 50},
	{ Index = "food_apple", Amount = 0, Price = 50},
	{ Index = "ammo_gravelerock", Amount = 3, Price = 30},
	{ Index = "seed_reviver", Amount = 0, Price = 200},
	{ Index = "seed_blast", Amount = 0, Price = 30},
	{ Index = "seed_sleep", Amount = 0, Price = 80},
	{ Index = "seed_warp", Amount = 0, Price = 60}
}
-- Purple Kecleon
SV.wares_shop = {
  { Index = "orb_escape", Amount = 3, Price = 300},
  { Index = "orb_rollcall", Amount = 3, Price = 100},
  { Index = "orb_scanner", Amount = 3, Price = 100},
  { Index = "orb_luminous", Amount = 3, Price = 100}
}
--
SV.base_trades = {
