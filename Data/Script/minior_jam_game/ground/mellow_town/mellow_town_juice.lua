...
local mellow_town_juice = {}



function mellow_town_juice.TEA_COUNTER_Action(chara, activator)
  DEBUG.EnableDbgCoro() --Enable debugging this coroutine


  UI:SetSpeaker(chara)

  --UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Tea_Intro']))
  mellow_town_juice.Juice_Shop(obj, activator)

end

mellow_town_juice.boost_tbl = { }
--{ Level = 0, EXP = 100, HP = 0, Atk = 0, Def = 0, SpAtk = 0, SpDef = 0, Speed = 0, NegateExp = false, NegateStat = false, GummiEffect = nil}
mellow_town_juice.boost_tbl["food_apple"] = { EXP = 100 }
mellow_town_juice.boost_tbl["food_apple_big"] = { EXP = 300 }
mellow_town_juice.boost_tbl["food_apple_huge"] = { EXP = 2500 }
mellow_town_juice.boost_tbl["food_apple_perfect"] = { EXP = 25000 }
mellow_town_juice.boost_tbl["food_apple_golden"] = { Level = 100 }
mellow_town_juice.boost_tbl["food_banana"] = { EXP = 1000 }
mellow_town_juice.boost_tbl["food_banana_big"] = { EXP = 5000 }
mellow_town_juice.boost_tbl["food_banana_golden"] = { Level = 100 }

mellow_town_juice.boost_tbl["berry_oran"] = { HP = 1 }
mellow_town_juice.boost_tbl["berry_leppa"] = { HP = 1 }
mellow_town_juice.boost_tbl["berry_sitrus"] = { HP = 1 }
mellow_town_juice.boost_tbl["berry_lum"] = { HP = 1 }

mellow_town_juice.boost_tbl["berry_passho"] = { HP = 1 }
mellow_town_juice.boost_tbl["berry_colbur"] = { HP = 1 }
mellow_town_juice.boost_tbl["berry_yache"] = { SpDef = 1 }
mellow_town_juice.boost_tbl["berry_rindo"] = { SpDef = 1 }
mellow_town_juice.boost_tbl["berry_tanga"] = { Speed = 1 }
mellow_town_juice.boost_tbl["berry_shuca"] = { Atk = 1 }
mellow_town_juice.boost_tbl["berry_chople"] = { Atk = 1 }
mellow_town_juice.boost_tbl["berry_payapa"] = { SpAtk = 1 }
mellow_town_juice.boost_tbl["berry_kebia"] = { Def = 1 }
mellow_town_juice.boost_tbl["berry_kasib"] = { SpAtk = 1 }
mellow_town_juice.boost_tbl["berry_occa"] = { SpAtk = 1 }
mellow_town_juice.boost_tbl["berry_haban"] = { Atk = 1 }
mellow_town_juice.boost_tbl["berry_babiri"] = { Def = 1 }
mellow_town_juice.boost_tbl["berry_chilan"] = { HP = 1 }
mellow_town_juice.boost_tbl["berry_wacan"] = { Speed = 1 }
mellow_town_juice.boost_tbl["berry_coba"] = { Speed = 1 }
mellow_town_juice.boost_tbl["berry_charti"] = { Def = 1 }
mellow_town_juice.boost_tbl["berry_roseli"] = { SpDef = 1 }

mellow_town_juice.boost_tbl["berry_jaboca"] = { Def = 1 }
mellow_town_juice.boost_tbl["berry_rowap"] = { SpDef = 1 }

mellow_town_juice.boost_tbl["berry_liechi"] = { Atk = 2 }
mellow_town_juice.boost_tbl["berry_ganlon"] = { Def = 2 }
mellow_town_juice.boost_tbl["berry_petaya"] = { SpAtk = 2 }
mellow_town_juice.boost_tbl["berry_apicot"] = { SpDef = 2 }
mellow_town_juice.boost_tbl["berry_salac"] = { Speed = 2 }
mellow_town_juice.boost_tbl["berry_starf"] = { HP = 2 }
mellow_town_juice.boost_tbl["berry_micle"] = { Atk = 1, SpAtk = 1 }

mellow_town_juice.boost_tbl["berry_enigma"] = { HP = 1 }

mellow_town_juice.boost_tbl["gummi_wonder"] = { HP = 2, Atk = 2, Def = 2, SpAtk = 2, SpDef = 2, Speed = 2 }

mellow_town_juice.boost_tbl["gummi_blue"] = { HP = 2, GummiEffect = 'water' }
mellow_town_juice.boost_tbl["gummi_black"] = { HP = 2, GummiEffect = 'dark' }
mellow_town_juice.boost_tbl["gummi_clear"] = { SpDef = 2, GummiEffect = 'ice' }
mellow_town_juice.boost_tbl["gummi_grass"] = { SpDef = 2, GummiEffect = 'grass' }
mellow_town_juice.boost_tbl["gummi_green"] = { Speed = 2, GummiEffect = 'bug' }
mellow_town_juice.boost_tbl["gummi_brown"] = { Atk = 2, GummiEffect = 'ground' }
mellow_town_juice.boost_tbl["gummi_orange"] = { Atk = 2, GummiEffect = 'fighting' }
mellow_town_juice.boost_tbl["gummi_gold"] = { SpAtk = 2, GummiEffect = 'psychic' }
mellow_town_juice.boost_tbl["gummi_pink"] = { Def = 2, GummiEffect = 'poison' }
mellow_town_juice.boost_tbl["gummi_purple"] = { SpAtk = 2, GummiEffect = 'ghost' }
mellow_town_juice.boost_tbl["gummi_red"] = { SpAtk = 2, GummiEffect = 'fire' }
mellow_town_juice.boost_tbl["gummi_royal"] = { Atk = 2, GummiEffect = 'dragon' }
mellow_town_juice.boost_tbl["gummi_silver"] = { Def = 2, GummiEffect = 'steel' }
mellow_town_juice.boost_tbl["gummi_white"] = { HP = 2, GummiEffect = 'normal' }
mellow_town_juice.boost_tbl["gummi_yellow"] = { Speed = 2, GummiEffect = 'electric' }
mellow_town_juice.boost_tbl["gummi_sky"] = { Speed = 2, GummiEffect = 'flying' }
mellow_town_juice.boost_tbl["gummi_gray"] = { Def = 2, GummiEffect = 'rock' }
mellow_town_juice.boost_tbl["gummi_magenta"] = { SpDef = 2, GummiEffect = 'fairy' }

mellow_town_juice.boost_tbl["seed_plain"] = { EXP = 100 }
mellow_town_juice.boost_tbl["seed_reviver"] = { EXP = 800 }

mellow_town_juice.boost_tbl["seed_joy"] = { Level = 1 }
mellow_town_juice.boost_tbl["seed_golden"] = { Level = 5 }
mellow_town_juice.boost_tbl["seed_doom"] = { Level = -5 }

mellow_town_juice.boost_tbl["seed_hunger"] = { EXP = 500 }

mellow_town_juice.boost_tbl["seed_warp"] = { Speed = 1 }
mellow_town_juice.boost_tbl["seed_sleep"] = { HP = 1 }
mellow_town_juice.boost_tbl["seed_vile"] = { Def = 1, SpDef = 1 }
mellow_town_juice.boost_tbl["seed_blast"] = { Atk = 1 }
mellow_town_juice.boost_tbl["seed_blinker"] = { Speed = 1 }

mellow_town_juice.boost_tbl["seed_pure"] = { EXP = 100 }
mellow_town_juice.boost_tbl["seed_ice"] = { Speed = 1 }
mellow_town_juice.boost_tbl["seed_decoy"] = { SpDef = 1 }
mellow_town_juice.boost_tbl["seed_last_chance"] = { Atk = 1, SpAtk = 1 }
mellow_town_juice.boost_tbl["seed_ban"] = { EXP = 100 }

mellow_town_juice.boost_tbl["boost_nectar"] = { HP = 1, Atk = 1, Def = 1, SpAtk = 1, SpDef = 1, Speed = 1 }

mellow_town_juice.boost_tbl["boost_hp_up"] = { HP = 8 }
mellow_town_juice.boost_tbl["boost_protein"] = { Atk = 8 }
mellow_town_juice.boost_tbl["boost_iron"] = { Def = 8 }
mellow_town_juice.boost_tbl["boost_calcium"] = { SpAtk = 8 }
mellow_town_juice.boost_tbl["boost_zinc"] = { SpDef = 8 }
mellow_town_juice.boost_tbl["boost_carbos"] = { Speed = 8 }

mellow_town_juice.boost_tbl["medicine_amber_tear"] = { HP = 1, Atk = 1, Def = 1, SpAtk = 1, SpDef = 1, Speed = 1 }

mellow_town_juice.boost_tbl["herb_mental"] = { NegateStatA = true }
mellow_town_juice.boost_tbl["herb_power"] = { NegateStatB = true }
mellow_town_juice.boost_tbl["herb_white"] = { NegateStatC = true }

mellow_town_juice.boost_tbl["food_grimy"] = { NegateExp = true }





function mellow_town_juice.getTotalBoost(cart, member)
	...
	for ii = 1, #cart, 1 do
		...
		local boost = mellow_town_juice.boost_tbl[item.ID]
...
function mellow_town_juice.Drink_Flow(boost, member)
	...
	if not any_boost then
		UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Tea_Order_Result_None'], member:GetDisplayName(true)))
	end

end


function mellow_town_juice.Drink_Order_Flow()
  ...
  while state > -1 do
    ...
    if state == 0 then
      UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Tea_Order_Who']))
    ...
    elseif state == 1 then
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Tea_Order_What'], STRINGS:LocalKeyString(26)))

	  local result = JuiceShopMenu.run(STRINGS:FormatKey("MENU_ITEM_TITLE"), member, mellow_town_juice.boost_tbl, true, SV.base_town.JuiceShop > 2, function(cart, member) return mellow_town_juice.getTotalBoost(cart, member) end) -- preview is set to be post game only

	  if #result > 0 then
		cart = result

		local total_boost = mellow_town_juice.getTotalBoost(cart, member)
    ...
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Tea_Order_Begin']))
		SOUND:PlayBattleSE("DUN_Drink")
    UI:ResetSpeaker()
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Tea_Order_Drink'], member:GetDisplayName(true)))
		mellow_town_juice.Drink_Flow(total_boost, member)
        state = -1
      else
        state = 0
      end
...
function mellow_town_juice.Can_Eat(target, effect)
...
function mellow_town_juice.Compute_Total_Tribute(target, effect)
	--TODO

	return {}
end

function mellow_town_juice.Drink_Specialties_Flow()
  ...
  while state > -1 do
    ...
    if state == 0 then
      selection = SpecialtiesMenu.run("Specialties", mellow_town_juice.specialties)
      if selection then
		state = 1
	  else
		state = -1
    ...
    elseif state == 1 then
	  local effect = mellow_town_juice.specialties[selection.Choice].Sizes[selection.Size].Effect
	  local total_boost = { EXP = 0, Level = 0, HP = 0, Atk = 0, Def = 0, SpAtk = 0, SpDef = 0, Speed = 0 }
	  if effect.Level ~= nil then
      ...
      UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Tea_Order_Who_Multi'], STRINGS:LocalKeyString(26)))
	  ...
	  local members = AssemblyMultiSelectMenu.runMultiMenu(function(target) return mellow_town_juice.Can_Eat(target, total_boost) end)

	  if #members > 0 then
		local tribute = mellow_town_juice.Compute_Total_Tribute(target, total_boost)
...
function mellow_town_juice.Juice_Shop(obj, activator)

  local state = 0
  local repeated = false
  local chara = CH('DRINK_Polteageist')
  local child = CH("DRINK_Sinistea")
  UI:SetSpeaker(chara)

  -- if SV.guildmaster_summit.GameComplete and SV.base_town.JuiceShop == 2 then
  --   UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Tea_Now_Specialty']))
  ...
  -- end
	...
	while state > -1 do
		if state == 0 then
      UI:SetSpeaker(chara)
			msg = STRINGS:Format(STRINGS.MapStrings['Tea_Intro_1'])
			if repeated == true then
				msg = STRINGS:Format(STRINGS.MapStrings['Tea_Intro_Return'])
			end
			local juice_choices = {}
			juice_choices[1] = STRINGS:Format(STRINGS.MapStrings['Tea_Option_Order'])


			if SV.base_town.JuiceShop == 3 then
				juice_choices[2] = STRINGS:Format(STRINGS.MapStrings['Tea_Option_Specialties'])
			end
			...
			if result == 1 then
				...
				if bag_count > 0 then
					mellow_town_juice.Drink_Order_Flow()
				else
					UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Tea_Bag_Empty']))
				end
			elseif result == 2 then
				mellow_town_juice.Drink_Specialties_Flow()
			elseif result == 3 then
				UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Tea_Info_001']))
				if SV.base_town.JuiceShop == 3 then
				    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Tea_Info_002']))
				end
			else
				UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Tea_Goodbye']))
				state = -1
			end
		end
	end
